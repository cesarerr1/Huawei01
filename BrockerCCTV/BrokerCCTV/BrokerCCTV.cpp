...
// BrokerCCTV.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CBrokerCCTVApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CBrokerCCTVApp

CBrokerCCTVApp::CBrokerCCTVApp()
{
...
// El único objeto CBrokerCCTVApp

CBrokerCCTVApp theApp;


// Inicialización de CBrokerCCTVApp

BOOL CBrokerCCTVApp::InitInstance()
{
