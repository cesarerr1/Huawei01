...
// ModuloCCTV.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CModuloCCTVApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CModuloCCTVApp

CModuloCCTVApp::CModuloCCTVApp()
{
...
// El único objeto CModuloCCTVApp

CModuloCCTVApp theApp;


// Inicialización de CModuloCCTVApp

BOOL CModuloCCTVApp::InitInstance()
{
