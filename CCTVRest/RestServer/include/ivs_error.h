...
typedef enum enIvsError
{
    ...
    IVS_SMU_VCN500_NOT_SUPPORT_SHADOW_DEV  = 119108153,   // VCN500不支持克隆设备
    ...
    IVS_SMU_TOKEN_INVALIDATE               = 119101357,    //用户登录token值无效
    ...
    IVS_SMU_CLUSTER_CG_DEV_BEYOND_LIMITED  = 119126029,    // 浮动网关上的设备超出接入能力
    ...
    ***********************************************/
    ...
    IVS_MU_VIRTUAL_IPC_SIZE_OVERLOAD       = 169100303,    // 虚拟IPC超出最大值
    IVS_MU_DEVICE_DELETE                   = 169100304,    // 设备被删除
    ...
    *******************************************/
    ...
    IVS_DCG_GET_ABS_POSITION_ERROR        = 189116012,     // 获取云台坐标参数错误
    ...
    IVS_DCG_GET_AUDIO_ALARM_PARAM_ERROR   = 189120029,     // 获取音频告警参数失败
    ...
    *******************************************/
	...
	IVS_OCX_ISNOT_REGIST					= 999115100,    // OCX控件未注册
	IVS_OCX_REGIST_ERROR					= 999115101,    // OCX控件注册错误
	...
	IVS_SDK_ERR_DOMAINCODE_ERR				= 999115399,	//域编码错误(同时对多个设备操作，但是不属于同一个域)
	...
	IVS_SDK_PLAYING_TVWALL				   = 999119251,       // 解码器正在电视上墙
